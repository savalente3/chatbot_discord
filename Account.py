...
name = input("Tell me about your self, what is your name?")
def intro(name):
    print("Well hello " + str(name) + "!")
    intro.str_age = float(input("Tell me " + str(name) + " more things about you, how old are you?"))
    ...
    print("Alright, I think I have everything I need!")
